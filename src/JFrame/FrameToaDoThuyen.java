...
public class FrameToaDoThuyen extends JFrame {
	...
	public static JLabel lblB_3;
	public static JLabel lblC_3;
	...
	public FrameToaDoThuyen() {
		...
		lblNewLabel_1 = new JLabel("\u0110\u00E1y thuy\u1EC1n");
		...
		lblD_1.setBounds(262, 60, 247, 46);
		layeredPane_1.add(lblD_1);
		
		JLabel lblNewLabel_1_1 = new JLabel("H\u00ECnh ch\u1EEF nh\u1EADt");
		...
		lblNewLabel_1_2 = new JLabel("H\u00ECnh tam gi\u00E1c b\u00EAn ph\u1EA3i");
		...
		lblB_3.setBounds(262, 1, 247, 46);
		layeredPane_3.add(lblB_3);
		
		lblC_3 = new JLabel("C");
		lblC_3.setFont(new Font("Tahoma", Font.PLAIN, 15));
		lblC_3.setBounds(3, 60, 247, 46);
		layeredPane_3.add(lblC_3);
		
		lblNewLabel_1_3 = new JLabel("T\u00E2m 3 h\u00ECnh tr\u00F2n");
